    ...
    <Card
      title={
        <div className="flex items-center">
          ...
          <span className="text-gray-800 font-semibold">学术政策</span>
        </div>
      }
      extra={
        <Link href="/academic-policies" className="text-purple-600 hover:text-purple-700 font-medium">
          更多 →
        </Link>
      }
      className="h-full border-t-4 border-purple-500 shadow-sm hover:shadow-md transition-shadow"
    >
            ...
            className="hover:bg-gray-50 transition-colors duration-200 cursor-pointer px-2 py-3">
              <div className="w-full">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <Tag color="purple" className="shrink-0 font-medium">
                    学术
                  </Tag>
                </div>
